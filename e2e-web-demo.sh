...
echo ""
echo -e "${YELLOW}⚠️  IMPORTANT: If you've used the web client before${NC}"
echo "   Clear browser storage (F12 → Application → Clear site data)"
echo "   This ensures it connects to localhost instead of production!"
echo ""
