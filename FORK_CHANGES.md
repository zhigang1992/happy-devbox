...
**Status:** [x] PRs Submitted
- happy-server: https://github.com/slopus/happy-server/pull/16
- happy (webapp): https://github.com/slopus/happy/pull/258
...
Changes included:
- [x] happy: Voice settings UI changes
- [x] happy: apiVoice.ts
- [x] happy: VoiceAssistantStatusBar changes
- [x] happy: settings.ts additions
- [x] happy: i18n strings for voice
- [x] happy-server: voiceRoutes.ts changes
- [ ] happy-cli: @elevenlabs/elevenlabs-js dependency (not included in PR)
